...
// go build -v -ldflags "-X github.com/raedahgroup/godcr-gio/version.appPreRelease= -X github.com/raedahgroup/godcr-gio/version.appBuild=`git rev-parse --short HEAD`"
var (
