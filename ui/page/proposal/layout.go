...
func (pg *Page) initLayoutWidgets() {
	pg.multiWallet = pg.WL.MultiWallet
	pg.selectedCategoryIndex = -1
...
func (pg *Page) layoutContent(gtx C) D {
	pg.proposalMu.Lock()
...
func (pg *Page) layoutProposalsList(gtx C) D {
	pg.proposalMu.Lock()
	proposalItems := pg.proposalItems
	pg.proposalMu.Unlock()
...
func (pg *Page) layoutNoProposalsFound(gtx C) D {
	pg.proposalMu.Lock()
...
func (pg *Page) layoutSyncSection(gtx C) D {
...
func (pg *Page) layoutAuthorAndDate(gtx C, item proposalItem) D {
	proposal := item.proposal
...
func (pg *Page) layoutInfoTooltip(gtx C, rect image.Rectangle, item proposalItem) {
...
func (pg *Page) layoutTitle(gtx C, proposal dcrlibwallet.Proposal) D {
...
func (pg *Page) layoutProposalVoteBar(gtx C, item proposalItem) D {
	proposal := item.proposal
...
func (pg *Page) layoutIsSyncedSection(gtx C) D {
	return layout.Flex{}.Layout(gtx,
		layout.Rigid(func(gtx C) D {
...
func (pg *Page) layoutIsSyncingSection(gtx C) D {
...
func (pg *Page) layoutStartSyncSection(gtx C) D {
