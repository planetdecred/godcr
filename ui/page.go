...
func loadPages(common *pageCommon, l *load.Load) map[string]Page {
	...
	pages[page.More] = page.NewMorePage(l)
	pages[page.Receive] = page.NewReceivePage(l)
	pages[PageSend] = SendPage(common)
	pages[page.VerifyMessage] = page.NewVerifyMessagePage(l)
	pages[page.PageSeedBackup] = page.NewBackupPage(l)
	pages[page.Settings] = page.NewSettingsPage(l)
	pages[page.SecurityTools] = page.NewSecurityToolsPage(l)
	pages[page.Debug] = page.NewDebugPage(l)
	pages[page.Log] = page.NewLogPage(l)
	pages[page.Statistics] = page.NewStatPage(l)
	pages[page.About] = page.NewAboutPage(l)
	pages[page.Help] = page.NewHelpPage(l)
