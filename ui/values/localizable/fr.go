...
"newSpendingPassword" = "Nouvelle phrase secrète de dépenses";
"confirmNewSpendingPassword" = "Confirmer la nouvelle phrase de passe des dépenses";
