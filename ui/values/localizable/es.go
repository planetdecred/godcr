...
"startupPassphraseEnabled" = "Contraseña de inicio habilitada"
...
"startupPassphrase" = "Contraseña de inicio";
...
"createStartupPassphrase" = "Crea una contraseña de inicio";
...
"verifyMessageInfo" = "%v Después de que usted o su contraparte haya generado una firma, puede usar este formulario para verificar la validez de la firma. %v Una vez que haya ingresado la dirección, el mensaje y la firma correspondiente, verá %v VÁLIDO %v si la firma coincide con la dirección y el mensaje, de lo contrario, %v NO VÁLIDO %v.%v"
...
"backupInfo" = "%v Haga una copia de seguridad de sus palabras clave y guárdelas en un lugar seguro para recuperar sus fondos si su dispositivo se pierde o se rompe. %v ¡Cualquier persona que tenga sus palabras clave puede gastar sus fondos! No las comparta. %v"
...
"immatureInfo" = "Esta participación ingresará al grupo de participación y se convertirá en una participación en vivo después de %d bloques (~%s)".
