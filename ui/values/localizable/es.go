...
"connectedPeersCount" = "Número de pares conectados";
"noConnectedPeer" = "No hay pares conectados.";
...
"connection" = "Conexión";
"connectToSpecificPeer" = "Conectarse a un par específico";
"changeSpecificPeer" = "Cambiar a un par en específico";
