...
func checkIfExists(file *os.File, name string) error {
...
func genIcons() error {
	...
	// todo : if file exists, read content and write old content. Skip initial package name
	// todo: if file does not exist proceed as normal
	...
	for _, info := range infos {
		...
		if err := checkIfExists(iconFile, n); err == nil {
			continue
		}
