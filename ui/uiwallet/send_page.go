...
func (w *Wallet) SendPage(common pageCommon) layout.Widget {
	pg := &sendPage{
		pageContainer: layout.List{
		...
		txAuthor:        &w.txAuthor,
		broadcastResult: &w.broadcastResult,
	...
	pg.passwordEditor = w.theme.EditorPassword(new(widget.Editor), "Spending password")
