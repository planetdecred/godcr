...
func (w *Wallet) OverviewPage(c pageCommon) layout.Widget {
	pg := overviewPage{
		theme: c.theme,
		tab:   c.navTab,

		walletInfo:         w.walletInfo,
		walletSyncStatus:   w.walletSyncStatus,
		walletTransactions: &w.walletTransactions,
		walletTransaction:  &w.walletTransaction,
