...
func (w *Wallet) LoadModalTemplates() *ModalTemplate {
	cancel := w.theme.Button(new(widget.Clickable), "Cancel")
	cancel.TextSize = values.TextSize16
	return &ModalTemplate{
		th:                    w.theme,
		confirm:               w.theme.Button(new(widget.Clickable), "Confirm"),
		cancel:                cancel,
		walletName:            w.theme.Editor(new(widget.Editor), ""),
		oldSpendingPassword:   w.theme.EditorPassword(new(widget.Editor), "Old spending password"),
		spendingPassword:      w.theme.EditorPassword(new(widget.Editor), "Spending password"),
		matchSpendingPassword: w.theme.EditorPassword(new(widget.Editor), "Confirm spending password"),
		extendedPublicKey:     w.theme.Editor(new(widget.Editor), "Extended public key"),
