...
func (win *Window) LoadModalTemplates() *ModalTemplate {
	return &ModalTemplate{
		...
		oldSpendingPassword:   win.theme.EditorPassword(new(widget.Editor), "Old spending password", true),
		spendingPassword:      win.theme.EditorPassword(new(widget.Editor), "Spending password", true),
		matchSpendingPassword: win.theme.EditorPassword(new(widget.Editor), "Confirm spending password", true),
